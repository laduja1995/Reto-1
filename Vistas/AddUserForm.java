...
public class AddUserForm extends javax.swing.JFrame {
  ...
  Conexion conexion ();
    ...
    public AddUserForm() throws ClassNotFoundException, SQLException {
    ...
    private void initComponents() {
        ...
        cbDocumentType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula de ciudadania", "Cédula de extranjería", "Libreta Militar", "Pasaporte", "otro" }));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
      ...
      String Apellido;
      String documento;
        System.out.println("Nombre" + nombre + "" + Apellido + "Documento:" + indexTipoDocumento + "" + tipoDocumento + "" + documento + ", correo"  + correo );
        
        if (nombre.isEmpty() || apellido.isEmpty() || documento.isEmpty() || correo.isEmpty() ){
        
              JOptionPane.showMessageDialog(this, "Hay campos requeridos sin diligenciar", "Formulario registro", OPtionPane.WARNING_MESSAGE);{
